...
{
    /// <summary>
    /// Project Rock Paper Scissors (Images)
    /// This class is called from the RPSProject class, RPSImages stores the images that are displaYed when the program is run
